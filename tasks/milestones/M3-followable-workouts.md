# M3: Followable workouts

## Goal

Let a lifter load a planned workout, follow it during training, and save completed results.

## Exit criteria

- A generated workout can be loaded into the app.
