...
public interface TrainingDataStore extends Database {
  List<SqliteDb.LiftExecutionRow> getExecutionsBetween(LocalDate start, LocalDate end)
      throws Exception;

  SqliteDb.ExecutionHistorySummary executionHistorySummary(LocalDate start, LocalDate end)
      throws Exception;
